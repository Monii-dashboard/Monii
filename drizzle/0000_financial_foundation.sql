...
--> statement-breakpoint
CREATE TABLE "ingestion"."account_match_assessments" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "account_match_assessments_ordered_pair" CHECK ("ingestion"."account_match_assessments"."left_external_account_id"::text < "ingestion"."account_match_assessments"."right_external_account_id"::text),
	CONSTRAINT "account_match_assessments_classification_valid" CHECK ("ingestion"."account_match_assessments"."classification" in ('confirmed_duplicate', 'likely_duplicate', 'dismissed'))
);
--> statement-breakpoint
...
CREATE TABLE "ingestion"."reported_account_valuations" (
	"valuation_candidate_id" uuid PRIMARY KEY NOT NULL,
...
CREATE TABLE "wealth"."snapshots" (
	...
	"recorded_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "snapshots_reason_valid" CHECK ("wealth"."snapshots"."reason" in ('synchronization', 'account_policy_changed')),
	CONSTRAINT "snapshots_reason_shape_valid" CHECK (("wealth"."snapshots"."reason" = 'synchronization' and "wealth"."snapshots"."synchronization_run_id" is not null) or ("wealth"."snapshots"."reason" = 'account_policy_changed' and "wealth"."snapshots"."synchronization_run_id" is null)),
...
ALTER TABLE "ingestion"."account_match_assessments" ADD CONSTRAINT "account_matches_left_external_account_fk" FOREIGN KEY ("left_external_account_id") REFERENCES "ingestion"."external_accounts"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ingestion"."account_match_assessments" ADD CONSTRAINT "account_matches_right_external_account_fk" FOREIGN KEY ("right_external_account_id") REFERENCES "ingestion"."external_accounts"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ingestion"."account_match_assessments" ADD CONSTRAINT "account_matches_first_run_fk" FOREIGN KEY ("first_detected_run_id") REFERENCES "ingestion"."synchronization_runs"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ingestion"."account_match_assessments" ADD CONSTRAINT "account_matches_last_run_fk" FOREIGN KEY ("last_detected_run_id") REFERENCES "ingestion"."synchronization_runs"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "ingestion"."connections" ADD CONSTRAINT "connections_external_institution_id_external_institutions_id_fk" FOREIGN KEY ("external_institution_id") REFERENCES "ingestion"."external_institutions"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ingestion"."external_account_observations" ADD CONSTRAINT "external_account_observations_account_id_accounts_id_fk" FOREIGN KEY ("account_id") REFERENCES "financial"."accounts"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ingestion"."external_account_observations" ADD CONSTRAINT "external_account_observations_source_fk" FOREIGN KEY ("source_instance_id") REFERENCES "ingestion"."source_instances"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ingestion"."external_account_observations" ADD CONSTRAINT "external_account_observations_run_fk" FOREIGN KEY ("synchronization_run_id") REFERENCES "ingestion"."synchronization_runs"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ingestion"."external_account_observations" ADD CONSTRAINT "external_account_observations_external_account_fk" FOREIGN KEY ("external_account_id") REFERENCES "ingestion"."external_accounts"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "ingestion"."external_accounts" ADD CONSTRAINT "external_accounts_connection_id_connections_id_fk" FOREIGN KEY ("connection_id") REFERENCES "ingestion"."connections"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "ingestion"."reported_account_valuations" ADD CONSTRAINT "reported_account_valuations_account_id_accounts_id_fk" FOREIGN KEY ("account_id") REFERENCES "financial"."accounts"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ingestion"."reported_account_valuations" ADD CONSTRAINT "reported_valuations_candidate_fk" FOREIGN KEY ("valuation_candidate_id") REFERENCES "financial"."account_valuation_candidates"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ingestion"."reported_account_valuations" ADD CONSTRAINT "reported_valuations_observation_fk" FOREIGN KEY ("external_account_observation_id") REFERENCES "ingestion"."external_account_observations"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ingestion"."synchronization_account_results" ADD CONSTRAINT "sync_account_results_source_fk" FOREIGN KEY ("source_instance_id") REFERENCES "ingestion"."source_instances"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ingestion"."synchronization_account_results" ADD CONSTRAINT "sync_account_results_run_fk" FOREIGN KEY ("synchronization_run_id") REFERENCES "ingestion"."synchronization_runs"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ingestion"."synchronization_account_results" ADD CONSTRAINT "sync_account_results_external_account_fk" FOREIGN KEY ("external_account_id") REFERENCES "ingestion"."external_accounts"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ingestion"."synchronization_account_results" ADD CONSTRAINT "sync_account_results_observation_fk" FOREIGN KEY ("external_account_observation_id") REFERENCES "ingestion"."external_account_observations"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ingestion"."synchronization_connection_results" ADD CONSTRAINT "sync_connection_results_source_fk" FOREIGN KEY ("source_instance_id") REFERENCES "ingestion"."source_instances"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ingestion"."synchronization_connection_results" ADD CONSTRAINT "sync_connection_results_run_fk" FOREIGN KEY ("synchronization_run_id") REFERENCES "ingestion"."synchronization_runs"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ingestion"."synchronization_connection_results" ADD CONSTRAINT "sync_connection_results_connection_fk" FOREIGN KEY ("connection_id") REFERENCES "ingestion"."connections"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "account_valuation_candidates_id_account_unique" ON "financial"."account_valuation_candidates" USING btree ("id","account_id");--> statement-breakpoint
CREATE UNIQUE INDEX "account_valuation_candidates_id_basis_unique" ON "financial"."account_valuation_candidates" USING btree ("id","valuation_basis");--> statement-breakpoint
...
CREATE UNIQUE INDEX "account_match_assessments_pair_unique" ON "ingestion"."account_match_assessments" USING btree ("left_external_account_id","right_external_account_id");--> statement-breakpoint
CREATE INDEX "account_match_assessments_right_account_idx" ON "ingestion"."account_match_assessments" USING btree ("right_external_account_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "connections_id_source_unique" ON "ingestion"."connections" USING btree ("id","source_instance_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "external_account_observations_provenance_unique" ON "ingestion"."external_account_observations" USING btree ("id","synchronization_run_id","external_account_id","source_instance_id");--> statement-breakpoint
CREATE UNIQUE INDEX "external_account_observations_id_account_unique" ON "ingestion"."external_account_observations" USING btree ("id","account_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "external_accounts_id_source_unique" ON "ingestion"."external_accounts" USING btree ("id","source_instance_id");--> statement-breakpoint
CREATE UNIQUE INDEX "external_accounts_id_account_unique" ON "ingestion"."external_accounts" USING btree ("id","account_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "external_institutions_id_source_unique" ON "ingestion"."external_institutions" USING btree ("id","source_instance_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "synchronization_runs_id_source_unique" ON "ingestion"."synchronization_runs" USING btree ("id","source_instance_id");--> statement-breakpoint
